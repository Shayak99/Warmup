...
function SinglePost({ post }) {
  ...
  return (
    <>
      <Home />
      <div className="m-9 font-semibold hover:bg-gray-100 py-8 px-8 max-w-5xl mx-auto bg-white rounded-xl space-y-2 sm:py-10 sm:flex sm:items-center sm:space-y-3 sm:space-x-6">
